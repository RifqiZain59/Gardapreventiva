      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              if (controller.selectedDoctor.value == null) {
                // TAMPILAN DAFTAR PASIEN (List Mode)
  ...
  Widget _buildDoctorList() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              "Belum ada pasien yang tersedia",
              style: TextStyle(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final int antreanCount =
            int.tryParse(doc['antrean']?.toString() ?? '0') ?? 0;
                        ...
                        ? Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: MemoryImage(base64Decode(doc['strImageBase64'])),
                                fit: BoxFit.cover,
                              ),
                            ),
                          )
...
class _ChatBubble extends StatelessWidget {
  ...
  void _showDeleteDialog(BuildContext context, NakesChatController controller) {
